 ...
 *    You may consider using one of the functions in `utils.tools.ArraySortTools` instead.
...
class SortUtil
{
   ...
   */
  /*public static inline function byStrumTime(order:Int, a:Note, b:Note):Int
    {
      return noteDataByTime(order, a.songNoteData, b.songNoteData);
  }*/
  /**
