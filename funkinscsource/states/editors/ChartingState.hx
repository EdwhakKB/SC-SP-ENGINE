...
import backend.data.FileDialogHandler;
...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
  ...
  override function update(elapsed:Float)
  {
    ...
    if (FlxG.mouse.justPressed && (FlxG.mouse.overlaps(mainBox.bg) || FlxG.mouse.overlaps(infoBox.bg))) ignoreClickForThisFrame = true;
  ...
  function loadMusic(?killAudio:Bool = false)
  {
    ...
    try
    {
      ...
      {
        var normalVocals = Paths.voices((PlayState.SONG.options.vocalsPrefix != null ? PlayState.SONG.options.vocalsPrefix : ''), PlayState.SONG.songId,
          (PlayState.SONG.options.vocalsSuffix != null ? PlayState.SONG.options.vocalsSuffix : ''));
        var playerVocals = Paths.voices((PlayState.SONG.options.vocalsPrefix != null ? PlayState.SONG.options.vocalsPrefix : ''), PlayState.SONG.songId,
          (PlayState.SONG.options.vocalsSuffix != null ? PlayState.SONG.options.vocalsSuffix : ''),
        ...
        var oppVocals = Paths.voices((PlayState.SONG.options.vocalsPrefix != null ? PlayState.SONG.options.vocalsPrefix : ''), PlayState.SONG.songId,
          (PlayState.SONG.options.vocalsSuffix != null ? PlayState.SONG.options.vocalsSuffix : ''),
  ...
  function reloadNotes()
  {
    ...
    for (eventNum => event in PlayState.SONG.events)
      if (cachedSectionTimes.length < 1
    ...
    susLengthStepper.onValueChange = function() {
      ...
      if (susLengthLastVal != susLengthStepper.value)
      {
        if (selectedNotes.length > 1)
        {
          ...
          selectedNotes[0].setSustainLength(susLengthStepper.value, Conductor.stepCrochet);
  ...
  function addSectionTab()
  {
    ...
    objY += 40;
    var copyButton:PsychUIButton = new PsychUIButton(objX, objY, 'Copy Section',
      function() showOutput('Feature not implemented yet!', true)); // TO DO: Add functionality
    var pasteButton:PsychUIButton = new PsychUIButton(objX + 100, objY, 'Paste Section',
      function() showOutput('Feature not implemented yet!', true)); // TO DO: Add functionality
    ...
    objY += 40;
    var copyLastSecButton:PsychUIButton = new PsychUIButton(objX, objY, 'Copy Last Section', function() showOutput('Feature not implemented yet!', true),
      100); // TO DO: Add functionality
  ...
  function addFileTab()
  {
    ...
    btnY += 20;
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Open Autosave...', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);
    ...
    btnY += 20;
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Open (V-Slice)...', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);
  ...
  function addEditTab()
  {
    ...
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Undo', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);

    btnY += 20;
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Redo', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);
  ...
  function addViewTab()
  {
    ...
    btnY++;
    btnY += 20;
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Metronome...', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);
    ...
    btnY++;
    btnY += 20;
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Waveform...', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);
    ...
    btnY++;
    btnY += 20;
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Search Note...', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);

    btnY += 20;
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Search Event...', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);

    btnY += 20;
    var btn:PsychUIButton = new PsychUIButton(btnX, btnY, '  Go to...', function() showOutput('Feature not implemented yet!', true),
      btnWid); // TO DO: Add functionality
    btn.text.alignment = LEFT;
    tab_group.add(btn);
