 ...
 */
@:nullSafety
class ChartEditorNotePreview extends charting.ChartEditorState.FunkinSprite
{
  //
  // Constants
  //
   ...
   * @param songLengthInMs The total length of the song in milliseconds.
   */
  public function addNotes(songNotes:Array<SongNoteData>, songLengthInMs:Int):Void
  {
   ...
   * @param songLengthInMs The total length of the song in milliseconds.
   */
  public function addSelectedNotes(songNotes:Array<SongNoteData>, songLengthInMs:Int):Void
  {
    for (note in songNotes)
    {
   ...
   * @param songLengthInMs The total length of the song in milliseconds.
   */
  public function addEvents(songEvents:Array<SongEventData>, songLengthInMs:Int):Void
  {
   ...
   * @param songLengthInMs The total length of the song in milliseconds.
   */
  public function addSelectedEvents(songEvents:Array<SongEventData>, songLengthInMs:Int):Void
  {
    for (event in songEvents)
    {
