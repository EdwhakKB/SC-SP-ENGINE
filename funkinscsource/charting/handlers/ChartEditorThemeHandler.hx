...
class ChartEditorThemeHandler
{
  ...
  static function updateGridBitmap(state:ChartEditorState):Void
  {
    ...
    var gridHeight:Int = Std.int(ChartEditorState.GRID_SIZE * Conductor.instance.stepsPerSection);
    ...
    for (i in 1...(Conductor.instance.stepsPerSection))
    {
    ...
    for (i in 1...(Conductor.instance.stepsPerSection))
    {
      if ((i % Conductor.instance.beatsPerSection) == 0)
      {
  ...
  static function updateMeasureTicks(state:ChartEditorState):Void
  {
    ...
    var ticksHeight:Int = Std.int(ChartEditorState.GRID_SIZE * Conductor.instance.stepsPerSection); // 1 measure tall.
    ...
    for (i in 1...(Conductor.instance.stepsPerSection))
    {
      ...
      {
        var beatTickY:Float = state.measureTickBitmap.height * i / Conductor.instance.stepsPerSection - (beatTickWidth / 2);
      ...
      {
        var stepTickY:Float = state.measureTickBitmap.height * i / Conductor.instance.stepsPerSection - (stepTickWidth / 2);
  ...
  static function updateOffsetTicks(state:ChartEditorState):Void
  {
    ...
    var ticksWidth:Int = Std.int(ChartEditorState.GRID_SIZE * Conductor.instance.stepsPerSection); // 10 minor ticks wide.
