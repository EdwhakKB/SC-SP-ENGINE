...
import charting.toolboxes.ChartEditorMetadataToolbox;
import charting.toolboxes.ChartEditorOffsetsToolbox;
import charting.toolboxes.ChartEditorFreeplayToolbox;
import charting.toolboxes.ChartEditorEventDataToolbox;
import charting.toolboxes.ChartEditorNoteDataToolbox;
...
class ChartEditorToolboxHandler
{
  ...
  public static function showToolbox(state:ChartEditorState, id:String):Void
  {
    ...
    if (toolbox != null)
    {
      ...
      state.playSound(Paths.getPath('sounds/chartingSounds/openWindow.ogg', SOUND));
  ...
  public static function hideToolbox(state:ChartEditorState, id:String):Void
  {
    ...
    if (toolbox != null)
    {
      ...
      state.playSound(Paths.getPath('sounds/chartingSounds/exitWindow.ogg', SOUND));
