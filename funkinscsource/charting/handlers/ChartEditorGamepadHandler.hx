...
class ChartEditorGamepadHandler
{
  ...
  static function handleGamepad(chartEditorState:ChartEditorState, gamepad:FlxGamepad):Void
  {
    ...
    else
    {
      ...
      {
        Debug.logInfo('Gamepad: Right shoulder pressed, toggling audio playback.');
      ...
      if (gamepad.justPressed.START)
      {
        ...
        Debug.logInfo('Gamepad: Start pressed, opening playtest (minimal: ${minimal})');
        chartEditorState.testSongInPlayState(minimal);
      }

      if (gamepad.justPressed.BACK && !gamepad.pressed.LEFT_SHOULDER)
      {
        Debug.logInfo('Gamepad: Back pressed, focusing on HaxeUI menu.');
      ...
      {
        Debug.logInfo('Gamepad: Back pressed, unfocusing on HaxeUI menu.');
    ...
    {
      Debug.logInfo('Gamepad: Guide pressed, quitting chart editor.');
...
class ChartEditorGamepadActionInputSource implements IActionInputSource
{
  ...
  public function handleGamepad(gamepad:FlxGamepad):Void
  {
    ...
    {
      Debug.logInfo('Gamepad: DPAD_LEFT pressed, moving left.');
    ...
    {
      Debug.logInfo('Gamepad: DPAD_RIGHT pressed, moving right.');
    ...
    {
      Debug.logInfo('Gamepad: DPAD_UP pressed, moving up.');
    ...
    {
      Debug.logInfo('Gamepad: DPAD_DOWN pressed, moving down.');
    ...
    {
      Debug.logInfo('Gamepad: A pressed, confirmingg.');
    ...
    {
      Debug.logInfo('Gamepad: B pressed, cancelling.');
    ...
    {
      Debug.logInfo('Gamepad: LEFT_TRIGGER pressed, moving to previous item.');
    ...
    {
      Debug.logInfo('Gamepad: RIGHT_TRIGGER pressed, moving to next item.');
