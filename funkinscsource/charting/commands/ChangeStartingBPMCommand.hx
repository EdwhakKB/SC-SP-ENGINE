...
class ChangeStartingBPMCommand implements ChartEditorCommand
{
  ...
  {
    var timeChanges:Array<SongTimeChange> = state.currentSongMetadata.songData.playData.timeChanges;
    ...
    state.currentSongMetadata.songData.playData.timeChanges = timeChanges;
