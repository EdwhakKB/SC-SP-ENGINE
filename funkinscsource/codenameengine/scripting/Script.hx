...
class Script extends FlxBasic implements IFlxDestroyable {
	...
	public static function getDefaultVariables(?script:Script):Map<String, Dynamic> {
		return [
			...
			"CustomCodeShader"	  => codenameengine.shaders.CustomCodeShader,
            "CustomShader"	  => codenameengine.shaders.CustomCodeShader,
	...
	public function new(path:String) {
		...
		if (states.PlayState.instance != null && states.PlayState.SONG != null && states.PlayState.SONG.notITG && ClientPrefs.getGameplaySetting('modchart')) modcharting.ModchartFuncs.loadHScriptFunctions(this);
		#end
