...
class SupportBETAFunctions
{
    ...
    public static function implement(funk:FunkinLua)
    {
		...
		funk.set("tweenColor", function(vars:String, duration:Float, initColor:FlxColor, finalColor:FlxColor, ease:String, ?tag:String) {
			...
			if(penisExam != null) 
			{
				if(tag != null)
				{
					...
					variables.set(tag, FlxTween.color(penisExam, duration, initColor, finalColor, {
				...
				else FlxTween.color(penisExam, duration, initColor, finalColor, {ease: LuaUtils.getTweenEaseByString(ease)});
			} 
			else FunkinLua.luaTrace('tweenColor: Couldnt find object: ' + vars, false, false, FlxColor.RED);
		});
		...
		funk.set("doTweenColor2", function(tag:String, vars:String, duration:Float, initColor:FlxColor, finalColor:FlxColor, ease:String, ?tag:String) {
			...
			else FunkinLua.luaTrace('doTweenColor2: Couldnt find object: ' + vars, false, false, FlxColor.RED);
		});
