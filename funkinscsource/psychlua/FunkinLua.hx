...
class FunkinLua
{
  ...
  public function new(scriptName:String, ?isStageLua:Bool = false, ?preloading:Bool = false, ?notScriptName:String = null)
  {
    ...
    set('bpm', PlayState.currentChart.timeChanges[0].bpm);
    set('scrollSpeed', PlayState.currentChart.scrollSpeed);
    set('crochet', Conductor.instance.crochet);
    set('stepCrochet', Conductor.instance.stepCrochet);
    set('songLength', 0);
    set('songName', PlayState.currentChart.songName);
    set('songPath', Paths.formatToSongPath(PlayState.currentChart.songName));
    set('startedCountdown', false);
    set('curStage', PlayState.currentChart.stage);
    ...
    set('hasVocals', PlayState.currentChart.needsVoices);
    set('hasSplitVocals', PlayState.currentChart.separateVocals);
    ...
    if (game != null)
    {
      ...
      // Character shit
      set('boyfriendName', PlayState.currentChart.characters.player);
      set('dadName', PlayState.currentChart.characters.opponent);
      set('gfName', PlayState.currentChart.characters.girlfriend);
      set('momName', PlayState.currentChart.characters.secondOpponent);
    }
    ...
    else
    {
      ...
      set("loadSong", function(?name:String = null, ?difficultyNum:Int = -1) {
        if (name == null || name.length < 1) name = PlayState.currentChart.songName;
        ...
        targetSong = backend.song.data.SongRegistry.instance.fetchEntry(Paths.formatToSongPath(name));
        if (targetSong == null)
        {
          FlxG.log.warn('WARN: could not find song with id (${Paths.formatToSongPath(name).toLowerCase()})');
          return;
        }
        targetDifficulty = Difficulty.getFilePath(difficultyNum).replace('-', "");
      ...
      set("doTweenColor", function(tag:String, vars:String, targetColor:String, duration:Float, ease:String) {
        ...
        if (itemExam != null)
        {
          if (Std.isOfType(itemExam, Character))
          {
            Reflect.setProperty(itemExam, 'doMissThing', 'false');
          }
      ...
      set("triggerEventLegacy",
        function(name:String, arg1:Dynamic, arg2:Dynamic, ?arg3:Dynamic, arg4:Dynamic, ?arg5:Dynamic, ?arg6:Dynamic, ?arg7:Dynamic, ?arg8:Dynamic,
          ...
          game.triggerEventLegacy(name, value1, value2, Conductor.instance.songPosition, value3, value4, value5, value6, value7, value8, value9, value10,
      ...
      set("triggerEvent", function(name:String, luaArgs:Array<Dynamic>) {
        ...
        game.triggerEvent(name, args, Conductor.instance.songPosition);
        return true;
      });
      ...
      set("setHealthBarColors", function(left:String, right:String) {
        ...
        if (PlayState.currentChart.options.oldBarSystem)
        {
      ...
      set("startDialogue", function(dialogueFile:String, music:String = null) {
        var path:String;
        var songPath:String = Paths.formatToSongPath(PlayState.currentChart.songName);
      ...
      set("getGeneralItem", function(item:String, instance:Bool = true) {
        try
        {
      ...
      set("setGeneralItem", function(item:String, value:Dynamic, instance:Bool = true) {
        try
        {
