package scfunkin.objects.graphics.audio.waveform;

import scfunkin.objects.graphics.rendering.MeshRender;
import scfunkin.backend.data.audio.waveform.WaveformData;
