...
class SpraycanAtlasSprite extends FlxSpriteGroup
{
  ...
  public var canAtlas:FunkinSCSprite;
  ...
  public function new(x:Float = 0, y:Float = 0)
  {
    ...
    canAtlas = new FunkinSCSprite(x, y, 'spraycanAtlas');
    ...
    canAtlas.antialiasing = Save.get('antialiasing');
    add(canAtlas);
    ...
    explosion.antialiasing = Save.get('antialiasing');
    add(explosion);
  }
