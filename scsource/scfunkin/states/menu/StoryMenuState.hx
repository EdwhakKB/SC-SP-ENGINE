...
import scfunkin.objects.ui.menu.MenuItem;
import scfunkin.objects.ui.menu.MenuCharacter;
...
class StoryMenuState extends MusicBeatState
{
  ...
  public function new(?stickers:scfunkin.vslice.transition.StickerSubState = null)
  {
    super();
  ...
  override function create()
  {
    ...
    if (WeekData.weeksList.length < 1)
    {
      ...
      MusicBeatState.switchState(new scfunkin.states.ErrorState("NO WEEKS ADDED FOR STORY MODE\n\nPress ACCEPT to go to the Week Editor Menu.\nPress BACK to return to Main Menu.",
