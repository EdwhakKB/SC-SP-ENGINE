...
import scfunkin.objects.ui.CheckboxThingie;
import scfunkin.objects.ui.AttachedText;
import scfunkin.play.input.InputFormatter;
import scfunkin.states.substates.options.Option;
...
class BaseOptionsMenu extends MusicBeatSubState
{
  ...
  public function new()
  {
    ...
    {
      var optionText:Alphabet = new Alphabet(220, 260, optionsArray[i].name, optionsArray[i].type == LINK);
